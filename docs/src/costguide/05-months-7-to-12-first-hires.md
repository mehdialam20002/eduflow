...
```mermaid
flowchart TD
    A["First working day of the month:<br/>read last month closing MRR"] --> B{"Rs 1 lakh<br/>reached?"}
    A --> C{"Rs 3 lakh<br/>reached?"}
    A --> D{"Rs 4.5 lakh<br/>reached?"}
    B -- "yes" --> E["Founder pay Rs 30,000<br/>hire support at 30 orgs"]
    C -- "yes" --> F["Founder pay Rs 60,000<br/>start inside sales ramp"]
    D -- "yes" --> G["Hire the full-stack engineer<br/>Rs 70,000 a month"]
    B -- "no" --> H["Nothing changes<br/>this month"]
    C -- "no" --> H
    D -- "no" --> H
```
