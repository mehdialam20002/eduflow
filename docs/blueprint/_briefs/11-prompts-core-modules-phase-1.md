# Brief for 11-prompts-core-modules-phase-1.md

Title: Prompts: Core Modules (Phase 1)
Minimum words: 5500
Web research needed: no

## What this chapter must cover (every item, fully)

This chapter of the Claude Code Prompt Library contains prompts P-11 to P-22 — use the exact IDs and titles from the shared index. Start with a short intro (what these prompts build, the order to run them, which day of the 60-day plan uses them) and a table (ID | Prompt | Reads these docs | Builds | Typical time).
