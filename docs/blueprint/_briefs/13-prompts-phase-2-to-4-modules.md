# Brief for 13-prompts-phase-2-to-4-modules.md

Title: Prompts: Phase 2 to 4 Modules
Minimum words: 6500
Web research needed: no

## What this chapter must cover (every item, fully)

This chapter of the Claude Code Prompt Library contains prompts P-33 to P-48 — use the exact IDs and titles from the shared index. Start with a short intro (what these prompts build, the order to run them, which day of the 60-day plan uses them) and a table (ID | Prompt | Reads these docs | Builds | Typical time).
